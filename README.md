# @applaud/cssnano-preset-default
...
```bash
$ npm install @applaud/cssnano-prreset-default
```
...
```js
const defaultPreset = require('@applaud/cssnano-preset-default');
...
### [`@applaud/postcss-svgo`](https://github.com/Applaud-devpack/postcss-svgo) (external)
